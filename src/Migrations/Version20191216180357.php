 ...
 */
final class Version20191216180357 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, nom_entreprise_id INT NOT NULL, titre VARCHAR(180) NOT NULL, description VARCHAR(255) NOT NULL, email VARCHAR(160) NOT NULL, INDEX IDX_C27C936928F01574 (nom_entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
